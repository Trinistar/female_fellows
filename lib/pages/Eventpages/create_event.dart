                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      subtitle: TextField(controller: Controller.planerController,decoration: InputDecoration(hintText: 'Trage die Materialien ein'),),
                    ),
                    ListTile(
                      isThreeLine: true,
                      leading: Image.asset(
                      ...
                      subtitle: TextField(controller: Controller.bookController,decoration: InputDecoration(hintText: 'Trage die Materialien ein'),),
                    ),
                    ListTile(
                      isThreeLine: true,
                      leading: Image.asset(
                      ...
                      subtitle: TextField(controller: Controller.foodController,decoration: InputDecoration(hintText: 'Trage die Materialien ein'),),
                    ),
                    ListTile(
                      isThreeLine: true,
                      leading: Image.asset(
                      ...
                      subtitle: TextField(controller: Controller.informationController,decoration: InputDecoration(hintText: 'Trage die Materialien ein'),),
                    ),
                    ListTile(
                      isThreeLine: true,
                      leading: Image.asset(
                      ...
                      title: Text('Kleidung'),
                      subtitle: TextField(controller: Controller.clothesController,decoration: InputDecoration(hintText: 'Trage die Materialien ein'),),
                    ),
                    SizedBox(
                      height: 20,
                    ),
