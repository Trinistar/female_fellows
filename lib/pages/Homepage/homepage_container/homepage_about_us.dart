            ...
            child: Column(
                ...
                children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                                ...
                                child:
                                    Image.asset('lib/images/unsereMission.png')),
                            Text(
                              'Unsere Mission',
                              style: TextStyle(fontSize: 20),
                            ),
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                           Navigator.push(context, MaterialPageRoute(builder: (context)=>FemPower()));
                      },
                      child: Container(
                        width: 320,
                        height: 100,
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>Kooperation()));
                      },
                      child: Container(
                        width: 320,
                        height: 100,
